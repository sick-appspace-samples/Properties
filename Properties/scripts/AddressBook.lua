...
---called when the Engine.OnStarted event is raised.
...
---Provides an additional function for the "Address" data type. The rest of the functionality of "Address" is just declared in the App Properties.
---@param addr Address
---@return string str
